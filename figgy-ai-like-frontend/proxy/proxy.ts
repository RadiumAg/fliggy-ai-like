...
async function runProxy() {
  ...
  const browser = await puppeteer.launch({
    ...
    args: [
      `--user-data-dir=C:/Users/20438/AppData/Local/Google/Chrome/User Data`,
    ],
  });

  const page = await browser.newPage();
  await page.goto('https://market.m.taobao.com/app/trip/rx-trip-ai/pages/home?spm=defwork.home.0.0.45fd5c4bI5cl0F&_projVer=1.7.2');
  return page;
}
